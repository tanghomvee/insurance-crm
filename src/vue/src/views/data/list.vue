	...
	<section>
		...
		<el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
			<el-form :inline="true" :model="filters">
				...
				<el-form-item>
					<el-input v-model="filters.carNo" placeholder="车牌号"></el-input>
				</el-form-item>
		...
		<el-table :data="contents" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column label="自带车牌"  with="auto"  		prop="carNo"></el-table-column>
			<el-table-column label="车辆品牌"  with="auto"  		prop="brand"></el-table-column>
			<el-table-column label="识别代码"  with="auto"  		prop="frameNo"></el-table-column>
		...
		<el-dialog title="编辑" v-model="editFormVisible" :close-on-click-modal="false">
			<el-form :model="editForm" label-width="80px" :rules="editFormRules" ref="editForm">
				...
				<el-form-item label="商业险保单号" prop="	viPolicy">
					<el-input placeHolder="商业险保单号" v-model="editForm.viPolicyNo">
					</el-input>
				</el-form-item>
...
<script>
	...
	import {addData, editData, listData} from '../../api/api';
